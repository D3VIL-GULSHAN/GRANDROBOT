...
PM_START_TEXT = """
**Tuturu {}, My Name is {}!** 
I am an **SUPERB**  group management bot based on Anime theme. Add me in Your group to manage your Group Easily.
...
TECHNO_IMG = "https://telegra.ph/file/a05879b7b097361e007da.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="https://github.com/NatthanDrake/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Tuturu, I am online.")
